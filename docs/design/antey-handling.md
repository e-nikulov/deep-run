...
Deep Run retains `14,700,000 kg` surfaced and `19,400,000 kg` submerged as public-reference values, but does not pretend that the inconsistent public displacement labels uniquely determine the production game's waterline. The normal gameplay hydrostatic state is calibrated to the accepted production geometry instead: **20,622,264 kg** fully submerged and **20,119.282 m³** fixed full displacement. With the retained 14,700 t surfaced mass, this gives 5,922.264 t of main-ballast water and ~40.29% gameplay reserve buoyancy. In flat water with zero trim and a level body, the resulting equilibrium is ~1.85155 m body-centre depth: the lowest bow-plane point is ~0.50 m above water and the highest propeller point remains ~0.878 m below it. This calibration is explicit GAME POLICY, not a historical or classified Project 949A hydrostatic claim. The displaced volume is a fixed physical property, so water-density changes alter buoyant force rather than silently resizing the boat.
