...
## Explicitly deferred from M4-A

M4-A does not yet add thermoclines, terrain occlusion, surface/bottom reflection, multipath, active sonar, contact/track fusion, cavitation signatures, biological emitters, AcousticDebugger UI, audio playback integration, weapons, damage, AI, or M5 work. Those remain later bounded M4 slices.
